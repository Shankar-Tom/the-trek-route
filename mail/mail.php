...
$outgoingServerAddress      = 'mail.thetrekroute.com'; // Consult your hosting provider.
...
$sendingAccountUsername     = 'no-reply@thetrekroute.com';
$sendingAccountPassword     = 'Anu@rag@9523';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'contact@thetrekroute.com'; // REQUIRED value.
...
$websiteName                = 'The Trek Route Contact Form';                // REQUIRED value. This is used when a name or email is not collected from the website form
...
$confirmationSubject        = "Thanks for Contacting The Trek Route"; // The subject of the confirmation email
$confirmationFromName       = "The Trek Route"; // Used in the "from" field of the email.
